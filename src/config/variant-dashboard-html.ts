...
// KCG fork: 변형 서브도메인 페이지를 만들지 않는다(단일 한국어 관제 페이지).
// index.html 의 원본 메타 앵커(og/twitter/hreflang 클러스터)도 제거돼 파생
// 자체가 불가능 — 목록을 비워 플러그인을 무력화한다.
export const WEB_DASHBOARD_VARIANTS = [] as const;
