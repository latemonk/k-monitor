...
export const SOURCE_TYPES: Record<string, SourceType> = {
  // KCG fork — 국내 소스
  '연합뉴스': 'wire', '뉴시스 속보': 'wire', '연합뉴스TV': 'wire', '연합뉴스 북한': 'wire',
  'SBS 뉴스': 'mainstream', 'JTBC 속보': 'mainstream', '조선일보': 'mainstream', '한겨레': 'mainstream',
  '경향신문': 'mainstream', '동아일보': 'mainstream', '한국경제': 'market', '세계일보': 'mainstream',
  'MBN': 'mainstream', '머니투데이': 'market', '오마이뉴스': 'mainstream',
  '해양수산부': 'gov', '통일부': 'gov', '행정안전부': 'gov',
  '해양경찰 뉴스': 'intel', '해상사고 뉴스': 'intel', '기상특보 뉴스': 'intel', '불법조업 뉴스': 'intel',
  '한국해운신문': 'intel', '쉬핑뉴스넷': 'intel', '현대해양': 'intel', '해사정보신문': 'intel',
  '해양한국': 'intel', '한국수산경제': 'intel', '데일리NK': 'intel',
  '인천일보': 'mainstream', '제주일보': 'mainstream', '전남일보': 'mainstream', '강원도민일보': 'mainstream', '경남신문': 'mainstream',
...
// ─── KCG fork: 국내 피드 오버라이드 ─────────────────────────────────────────
// politics = 국내 주요 뉴스, intel = 해양·안보 뉴스(해수부·해경·해운 전문지·
// 북한·재난 특보). 전부 2026-07-21 curl 실측 검증된 RSS. RSS 프록시
// allowlist(shared/rss-allowed-domains.json)에 도메인 등록 필수.
const KCG_POLITICS_FEEDS: Feed[] = [
  { name: '연합뉴스', url: rss('https://www.yna.co.kr/rss/news.xml') },
  { name: '뉴시스 속보', url: rss('https://www.newsis.com/RSS/sokbo.xml') },
  { name: '연합뉴스TV', url: rss('https://www.yonhapnewstv.co.kr/browse/feed/') },
  { name: 'SBS 뉴스', url: rss('https://news.sbs.co.kr/news/headlineRssFeed.do?plink=RSSREADER') },
  { name: 'JTBC 속보', url: rss('https://fs.jtbc.co.kr/RSS/newsflash.xml') },
  { name: '조선일보', url: rss('https://www.chosun.com/arc/outboundfeeds/rss/?outputType=xml') },
  { name: '한겨레', url: rss('https://www.hani.co.kr/rss') },
  { name: '경향신문', url: rss('https://www.khan.co.kr/rss/rssdata/total_news.xml') },
  { name: '동아일보', url: rss('https://rss.donga.com/total.xml') },
  { name: '한국경제', url: rss('https://www.hankyung.com/feed/all-news') },
  { name: '세계일보', url: rss('https://www.segye.com/Articles/RSSList/segye_recent.xml') },
  { name: 'MBN', url: rss('https://www.mbn.co.kr/rss/') },
  { name: '머니투데이', url: rss('https://rss.mt.co.kr/mt_news.xml') },
  { name: '오마이뉴스', url: rss('https://rss.ohmynews.com/rss/ohmynews.xml') },
  // 주제 선택용 토픽 피드 — 서버 digest(_feeds.ts full.politics)와 이름 1:1 필수
  { name: '정치 뉴스', url: rss('https://news.google.com/rss/search?q=%EC%A0%95%EC%B9%98&hl=ko&gl=KR&ceid=KR:ko') },
  { name: '경제 뉴스', url: rss('https://news.google.com/rss/search?q=%EA%B2%BD%EC%A0%9C&hl=ko&gl=KR&ceid=KR:ko') },
  { name: '사회 뉴스', url: rss('https://news.google.com/rss/search?q=%EC%82%AC%ED%9A%8C&hl=ko&gl=KR&ceid=KR:ko') },
];

const KCG_INTEL_FEEDS: Feed[] = [
  { name: '해양경찰 뉴스', url: rss('https://news.google.com/rss/search?q=%ED%95%B4%EC%96%91%EA%B2%BD%EC%B0%B0&hl=ko&gl=KR&ceid=KR:ko') },
  { name: '해양수산부', url: rss('https://www.mof.go.kr/doc/ko/rssFeed.do?bbsSeq=10') },
  { name: '해상사고 뉴스', url: rss('https://news.google.com/rss/search?q=(%ED%95%B4%EC%83%81%EC%82%AC%EA%B3%A0%20OR%20%EC%84%A0%EB%B0%95%EC%82%AC%EA%B3%A0%20OR%20%EC%A1%B0%EB%82%9C)&hl=ko&gl=KR&ceid=KR:ko') },
  { name: '기상특보 뉴스', url: rss('https://news.google.com/rss/search?q=(%EA%B8%B0%EC%83%81%ED%8A%B9%EB%B3%B4%20OR%20%ED%92%8D%EB%9E%91%EC%A3%BC%EC%9D%98%EB%B3%B4%20OR%20%ED%83%9C%ED%92%8D)&hl=ko&gl=KR&ceid=KR:ko') },
  { name: '불법조업 뉴스', url: rss('https://news.google.com/rss/search?q=(%EB%B6%88%EB%B2%95%EC%A1%B0%EC%97%85%20OR%20%EC%A4%91%EA%B5%AD%EC%96%B4%EC%84%A0%20OR%20NLL)&hl=ko&gl=KR&ceid=KR:ko') },
  { name: '한국해운신문', url: rss('https://www.maritimepress.co.kr/rss/allArticle.xml') },
  { name: '쉬핑뉴스넷', url: rss('https://www.shippingnewsnet.com/rss/allArticle.xml') },
  { name: '현대해양', url: rss('https://www.hdhy.co.kr/rss/allArticle.xml') },
  { name: '해사정보신문', url: rss('https://www.haesainfo.com/rss/allArticle.xml') },
  { name: '해양한국', url: rss('https://www.monthlymaritimekorea.com/rss/allArticle.xml') },
  { name: '연합뉴스 북한', url: rss('https://www.yna.co.kr/rss/northkorea.xml') },
  { name: '데일리NK', url: rss('https://www.dailynk.com/feed/') },
  { name: '통일부', url: rss('https://unikorea.go.kr/web/unikorea/rss/bbs_0000000000000004') },
  { name: '행정안전부', url: rss('https://www.mois.go.kr/gpms/view/jsp/rss/rss.jsp?ctxCd=1012') },
  { name: '인천일보', url: rss('https://www.incheonilbo.com/rss/allArticle.xml') },
  { name: '제주일보', url: rss('https://www.jejunews.com/rss/allArticle.xml') },
  { name: '전남일보', url: rss('https://www.jnilbo.com/rss/allArticle.xml') },
  { name: '강원도민일보', url: rss('https://www.kado.net/rss/allArticle.xml') },
  { name: '경남신문', url: rss('https://www.knnews.co.kr/rss/rss.php') },
  // 주제 선택용 토픽 피드 — 서버 digest(_feeds.ts full.intel)와 이름 1:1 필수
  { name: '재난 뉴스', url: rss('https://news.google.com/rss/search?q=(%EC%9E%AC%EB%82%9C%20OR%20%EC%A7%80%EC%A7%84%20OR%20%EC%82%B0%EB%B6%88%20OR%20%ED%98%B8%EC%9A%B0)&hl=ko&gl=KR&ceid=KR:ko') },
];

FULL_FEEDS.politics = KCG_POLITICS_FEEDS;
FULL_FEEDS.intel = KCG_INTEL_FEEDS;
...
export const INTEL_SOURCES: Feed[] = [
  // KCG fork: 해양·안보 소스 — 서버 digest(_feeds.ts full.intel)와 이름 1:1
  { name: '해양경찰 뉴스', url: rss('https://news.google.com/rss/search?q=%ED%95%B4%EC%96%91%EA%B2%BD%EC%B0%B0&hl=ko&gl=KR&ceid=KR:ko'), type: 'defense' },
  { name: '해양수산부', url: rss('https://www.mof.go.kr/doc/ko/rssFeed.do?bbsSeq=10'), type: 'gov' },
  { name: '해상사고 뉴스', url: rss('https://news.google.com/rss/search?q=(%ED%95%B4%EC%83%81%EC%82%AC%EA%B3%A0%20OR%20%EC%84%A0%EB%B0%95%EC%82%AC%EA%B3%A0%20OR%20%EC%A1%B0%EB%82%9C)&hl=ko&gl=KR&ceid=KR:ko'), type: 'defense' },
  { name: '기상특보 뉴스', url: rss('https://news.google.com/rss/search?q=(%EA%B8%B0%EC%83%81%ED%8A%B9%EB%B3%B4%20OR%20%ED%92%8D%EB%9E%91%EC%A3%BC%EC%9D%98%EB%B3%B4%20OR%20%ED%83%9C%ED%92%8D)&hl=ko&gl=KR&ceid=KR:ko'), type: 'defense' },
  { name: '불법조업 뉴스', url: rss('https://news.google.com/rss/search?q=(%EB%B6%88%EB%B2%95%EC%A1%B0%EC%97%85%20OR%20%EC%A4%91%EA%B5%AD%EC%96%B4%EC%84%A0%20OR%20NLL)&hl=ko&gl=KR&ceid=KR:ko'), type: 'defense' },
  { name: '한국해운신문', url: rss('https://www.maritimepress.co.kr/rss/allArticle.xml'), type: 'defense' },
  { name: '쉬핑뉴스넷', url: rss('https://www.shippingnewsnet.com/rss/allArticle.xml'), type: 'defense' },
  { name: '현대해양', url: rss('https://www.hdhy.co.kr/rss/allArticle.xml'), type: 'defense' },
  { name: '해사정보신문', url: rss('https://www.haesainfo.com/rss/allArticle.xml'), type: 'defense' },
  { name: '연합뉴스 북한', url: rss('https://www.yna.co.kr/rss/northkorea.xml'), type: 'defense' },
  { name: '데일리NK', url: rss('https://www.dailynk.com/feed/'), type: 'defense' },
  { name: '통일부', url: rss('https://unikorea.go.kr/web/unikorea/rss/bbs_0000000000000004'), type: 'gov' },
  { name: '인천일보', url: rss('https://www.incheonilbo.com/rss/allArticle.xml'), type: 'other' },
  { name: '제주일보', url: rss('https://www.jejunews.com/rss/allArticle.xml'), type: 'other' },
  { name: '강원도민일보', url: rss('https://www.kado.net/rss/allArticle.xml'), type: 'other' },
  { name: '재난 뉴스', url: rss('https://news.google.com/rss/search?q=(%EC%9E%AC%EB%82%9C%20OR%20%EC%A7%80%EC%A7%84%20OR%20%EC%82%B0%EB%B6%88%20OR%20%ED%98%B8%EC%9A%B0)&hl=ko&gl=KR&ceid=KR:ko'), type: 'other' },
];

// Default-enabled sources per panel (Tier 1+2 priority, ≥8 per panel)
export const DEFAULT_ENABLED_SOURCES: Record<string, string[]> = {
  // KCG fork: politics는 국내 피드로 교체됨 — 옛 영문 목록(BBC 등)은 더 이상
  // FULL_FEEDS에 없어 신규 방문자 sources-reduction 마이그레이션에서 국내
  // 피드가 전부 default-disabled 되는 문제가 있었음. 국내 피드 전체를 기본 활성.
  politics: [
    '연합뉴스', '뉴시스 속보', '연합뉴스TV', 'SBS 뉴스', 'JTBC 속보', '조선일보',
    '한겨레', '경향신문', '동아일보', '한국경제', '세계일보', 'MBN', '머니투데이',
    '오마이뉴스', '정치 뉴스', '경제 뉴스', '사회 뉴스',
  ],
...
export const DEFAULT_ENABLED_INTEL: string[] = [
  // KCG fork: 해양·안보 국내 피드 전체 기본 활성 (옛 영문 목록은 INTEL_SOURCES에 부재)
  '해양경찰 뉴스', '해양수산부', '해상사고 뉴스', '기상특보 뉴스', '불법조업 뉴스',
  '한국해운신문', '쉬핑뉴스넷', '현대해양', '해사정보신문', '해양한국',
  '한국수산경제', '연합뉴스 북한', '데일리NK', '통일부', '행정안전부',
  '인천일보', '제주일보', '전남일보', '강원도민일보', '경남신문', '재난 뉴스',
];

/**
 * KCG fork: 국내 피드 전체(politics+intel 기본 목록). ①무료 소스 캡(80)에서
 * 보호 ②일회성 disabledFeeds 복구 마이그레이션의 대상. 이 제품의 본체 콘텐츠라
 * 어떤 경로로도 자동 비활성화되면 안 된다.
 */
export const KCG_KOREAN_SOURCES: ReadonlySet<string> = new Set([
  ...(DEFAULT_ENABLED_SOURCES.politics ?? []),
