    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        <div class="header-left">
          ...
          <span class="logo">🇰🇷 K-Watch — 대한민국 AI 통합 관제</span><span class="logo-mobile">🇰🇷 K-Watch</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}<a class="version" href="https://github.com/latemonk/k-watch" target="_blank" rel="noopener" title="오픈소스예요 — 소스 코드 보기(AGPL-3.0)" style="text-decoration:none">소스</a>
