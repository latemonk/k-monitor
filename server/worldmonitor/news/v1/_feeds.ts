...
export const VARIANT_FEEDS: Record<string, Record<string, ServerFeed[]>> = {
  full: {
    // KCG fork: 국내 종합 뉴스 (client feeds.ts KCG_POLITICS_FEEDS와 이름 동일 유지)
    politics: [
      { name: '연합뉴스', url: 'https://www.yna.co.kr/rss/news.xml', lang: 'ko' },
      { name: '뉴시스 속보', url: 'https://www.newsis.com/RSS/sokbo.xml', lang: 'ko' },
      { name: '연합뉴스TV', url: 'https://www.yonhapnewstv.co.kr/browse/feed/', lang: 'ko' },
      { name: 'SBS 뉴스', url: 'https://news.sbs.co.kr/news/headlineRssFeed.do?plink=RSSREADER', lang: 'ko' },
      { name: 'JTBC 속보', url: 'https://fs.jtbc.co.kr/RSS/newsflash.xml', lang: 'ko' },
      { name: '조선일보', url: 'https://www.chosun.com/arc/outboundfeeds/rss/?outputType=xml', lang: 'ko' },
      { name: '한겨레', url: 'https://www.hani.co.kr/rss', lang: 'ko' },
      { name: '경향신문', url: 'https://www.khan.co.kr/rss/rssdata/total_news.xml', lang: 'ko' },
      { name: '동아일보', url: 'https://rss.donga.com/total.xml', lang: 'ko' },
      { name: '한국경제', url: 'https://www.hankyung.com/feed/all-news', lang: 'ko' },
      { name: '세계일보', url: 'https://www.segye.com/Articles/RSSList/segye_recent.xml', lang: 'ko' },
      { name: 'MBN', url: 'https://www.mbn.co.kr/rss/', lang: 'ko' },
      // 주제 선택용 토픽 피드 (client KCG_NEWS_TOPICS와 이름 1:1 — 2026-07-21 curl 실측 ~100건씩)
      { name: '정치 뉴스', url: gnLocale('정치', 'ko', 'KR', 'KR:ko'), lang: 'ko' },
      { name: '경제 뉴스', url: gnLocale('경제', 'ko', 'KR', 'KR:ko'), lang: 'ko' },
      { name: '사회 뉴스', url: gnLocale('사회', 'ko', 'KR', 'KR:ko'), lang: 'ko' },
    ],
    // KCG fork: 해양·안보 (client KCG_INTEL_FEEDS와 이름 동일)
    intel: [
      { name: '해양경찰 뉴스', url: gnLocale('해양경찰', 'ko', 'KR', 'KR:ko'), lang: 'ko' },
      { name: '해양수산부', url: 'https://www.mof.go.kr/doc/ko/rssFeed.do?bbsSeq=10', lang: 'ko' },
      ...
      { name: '연합뉴스 북한', url: 'https://www.yna.co.kr/rss/northkorea.xml', lang: 'ko' },
      { name: '데일리NK', url: 'https://www.dailynk.com/feed/', lang: 'ko' },
      { name: '통일부', url: 'https://unikorea.go.kr/web/unikorea/rss/bbs_0000000000000004', lang: 'ko' },
      { name: '인천일보', url: 'https://www.incheonilbo.com/rss/allArticle.xml', lang: 'ko' },
      { name: '제주일보', url: 'https://www.jejunews.com/rss/allArticle.xml', lang: 'ko' },
      { name: '강원도민일보', url: 'https://www.kado.net/rss/allArticle.xml', lang: 'ko' },
      // 주제 선택용 토픽 피드 (client KCG_NEWS_TOPICS와 이름 1:1 — 2026-07-21 curl 실측 ~100건)
      { name: '재난 뉴스', url: gnLocale('재난 OR 지진 OR 산불 OR 호우', 'ko', 'KR', 'KR:ko'), lang: 'ko' },
    ],
    us: [
